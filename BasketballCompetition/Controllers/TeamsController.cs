...
namespace BasketballCompetition.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TeamId,TeamName,Age,Phone")] Teams teams)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TeamId,TeamName,Age,Phone")] Teams teams)
        {
            if (id != teams.TeamId)
            {
                return NotFound();
